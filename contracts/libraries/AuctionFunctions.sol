...
import {AuctionStorage, NFT} from "./AuctionStorage.sol";
import "../../lib/openzeppelin-contracts/contracts/token/ERC721/ERC721.sol";
// import "../../lib/forge-std/lib";
import "lib/openzeppelin-contracts/contracts/token/ERC721/IERC721.sol";
import "lib/openzeppelin-contracts/contracts/token/ERC721/IERC721Receiver.sol";

library LibAuctionFunctions {
    // using LibAuctionStorage for LibAuctionStorage.AuctionStorage;
    ...
    modifier isValidID(uint voteId) {
        LibAuctionStorage.AuctionStorage storage ds;
        require((self.idUsed[voteId]), "INVALID ID");
        _;
    }
    ...
    function _createAuction(
        ...
        LibAuctionStorage.AuctionStorage storage ds = appStorage();
    ...
    function _AdminWithdrawal() internal {
        AuctionStorage storage ds = appStorage();
    ...
    function appStorage() internal pure returns (AuctionStorage) {
        AuctionStorage storage ds;
        assembly {
            ds.slot := 0
        }
    }
